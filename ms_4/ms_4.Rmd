...
criminal_rates_clean <- criminal_rates_clean %>% 
  select(-X1, -X7)
...
```{r sexual assault, rape, and sexual battery}

# Data from https://www.bjs.gov/index.cfm?ty=tp&tid=914 and
# https://www.bjs.gov/content/pub/pdf/App_E_Sex-Assault-Rape-Battery.pdf, the
# Bureau of Justice Statistics: "Appendix E: Data Tables for Sexual Assault,
# Rape, and Sexual Battery"

# I also read in some data that I thought would be relevant, and tried to clean
# it up a little bit.

sex_assault_rape_battery <- pdf_text("App_E_Sex-Assault-Rape-Battery.pdf") %>% 
  read_lines() %>% 
  strsplit(split = "\n")

View(sex_assault_rape_battery)
